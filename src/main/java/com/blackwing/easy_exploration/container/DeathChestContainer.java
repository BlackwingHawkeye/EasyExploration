package com.blackwing.easy_exploration.container;
...
public class DeathChestContainer extends Container {

    public final DeathChestTileEntity tileEntity;
     ...
     */
    public DeathChestContainer(final int windowId, final PlayerInventory playerInventory, final PacketBuffer data) {
        this(windowId, playerInventory, getTileEntity(playerInventory, data));
    }

    /**
     * Constructor called logical-server-side from {@link DeathChestTileEntity#createMenu}
     * and logical-client-side from {@link #DeathChestContainer(int, PlayerInventory, PacketBuffer)}
     */
    public DeathChestContainer(final int windowId, final PlayerInventory playerInventory, final DeathChestTileEntity tileEntity) {
        super(ModContainerTypes.DEATH_CHEST.get(), windowId);
    ...
    private static DeathChestTileEntity getTileEntity(final PlayerInventory playerInventory, final PacketBuffer data) {
        Objects.requireNonNull(playerInventory, "playerInventory cannot be null!");
        Objects.requireNonNull(data, "data cannot be null!");
        final TileEntity tileAtPos = playerInventory.player.world.getTileEntity(data.readBlockPos());
        if (tileAtPos instanceof DeathChestTileEntity)
            return (DeathChestTileEntity) tileAtPos;
    ...
    public boolean canInteractWith(@Nonnull final PlayerEntity player) {
        return isWithinUsableDistance(canInteractWithCallable, player, ModBlocks.DEATH_CHEST.get());
    }
